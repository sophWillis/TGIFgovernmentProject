         ...
         "members": [
              {
                 ...
                 "at_large": false,
                 "geoid": "3703"
                 ,"missed_votes_pct": 10.58,
                 "votes_with_party_pct": 61.04
               },
                           {
                 "id": "J000289",
                 "title": "Representative",
...
function generateTable(membersArray) {
    ...
    var div = document.getElementById("least");
...
//    div.innerHTML = "";
    ...
    for (var i = 0; i < membersArray.length; i++) {
        ...
        var missedNum = membersArray[i].missed_votes;
        var missedPct = membersArray[i].missed_votes_pct;
        
        td1.textContent = name;
        td2.textContent = missedNum;
        td3.textContent = missedPct;
